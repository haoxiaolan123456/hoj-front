...
export type { JudegCase } from './models/JudegCase';
export type { JudegConfig } from './models/JudegConfig';
export type { JudegInfo } from './models/JudegInfo';
...
export type { SubmitQuestionQueryRequest } from './models/SubmitQuestionQueryRequest';
export type { SubmitQuestionRequest } from './models/SubmitQuestionRequest';
export type { SubmitQuestionVO } from './models/SubmitQuestionVO';
